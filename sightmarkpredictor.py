...
print("Enter distances in meters and sight markings for archery(e.g., distance 20 with marking 15).")
...
while True:
    ...
    if distance.lower() == 'done':
        if len(distances) < 2:
            distance=input("Please enter at least two distance-marking pairs. Enter distance now:")
        else:
            break
...
plt.scatter(distances, sight_markings, color='#36b8ed', label='Actual Sight Marks')
